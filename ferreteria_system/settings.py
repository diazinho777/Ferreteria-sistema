"""
Django settings for ferreteria_system project.
...
SECRET_KEY = 'django-insecure-chy3ao2!#tj6h7tdg3fdlt26p_@!@dz(fug&_h@^*ggyyb)&7g'
...
ROOT_URLCONF = 'ferreteria_system.urls'
...
WSGI_APPLICATION = 'ferreteria_system.wsgi.application'
